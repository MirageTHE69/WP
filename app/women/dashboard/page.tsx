...
// Dummy data
const initialJobs = [
  { id: 1, title: "Stitching Expert", company: "FashionCo", category: "Stitching Work", type: "Remote" },
  { id: 2, title: "Boutique Manager", company: "ChicStyles", category: "Boutique Management", type: "In-office" },
...
export default function WomenDashboard() {
  ...
  return (
    <div className="container mx-auto px-6 py-8">
      <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-6">Women Dashboard</h1>
            ...
            <ul className="space-y-4">
              {appliedJobs.map((job, index) => (
                <li key={index} className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-blue-600 dark:text-blue-400">Applied</span>
                </li>
              ))}
            </ul>
          ) : (
