...
import { ArrowRight, Briefcase, Calendar, Users, Star, TrendingUp } from "lucide-react"

export default function Home() {
  return (
    <div className="container mx-auto px-6 py-12">
      <section className="text-center mb-20">
        <h1 className="text-5xl font-bold text-gray-800 dark:text-white mb-6">Empowering Women in the Workforce</h1>
        <p className="text-xl text-gray-600 dark:text-gray-300 mb-10 max-w-3xl mx-auto">
          Join our platform to connect with tailored job opportunities, attend professional events, and grow your career
          in a supportive community designed for women.
        </p>
        <div className="flex justify-center space-x-6">
          <Button asChild size="lg" className="text-lg px-8 py-6">
            <Link href="/register?role=woman">Join as a Woman</Link>
          </Button>
          <Button asChild variant="outline" size="lg" className="text-lg px-8 py-6">
            <Link href="/register?role=organization">Register Organization</Link>
          </Button>
        </div>
      </section>

      <section className="mb-20">
        <h2 className="text-4xl font-semibold text-gray-800 dark:text-white mb-10 text-center">How It Works</h2>
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {["Stitching Work", "Boutique Management", "Bag Making"].map((category) => (
            <Card key={category} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-300 text-lg mb-6">
                  Explore opportunities in {category.toLowerCase()} and start your career journey today.
                </p>
                <Button asChild variant="outline" className="w-full">
                  <Link href={`/women/jobs?category=${category.toLowerCase().replace(" ", "-")}`}>
      ...
      <section className="text-center">
        <h2 className="text-4xl font-semibold text-gray-800 dark:text-white mb-6">Ready to Take the Next Step?</h2>
        <p className="text-xl text-gray-600 dark:text-gray-300 mb-10 max-w-3xl mx-auto">
          Join our community of empowered women and supportive organizations today. Your dream career is just a click
          away!
        </p>
        <Button asChild size="lg" className="text-lg px-8 py-6">
